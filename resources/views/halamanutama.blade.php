...
@section('content')
    <div class="mb-4">
        <h1 class="text-2xl font-bold text-gray-800">Dashboard <span class="text-sm font-normal text-gray-500">Surat Masuk & Surat Keluar</span></h1>
    </div>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {{-- Kartu Surat Masuk --}}
        <div class="dark:bg-green-700 text-white rounded shadow p-4">
            <div class="flex justify-between items-center">
                ...
                <svg class="w-10 h-10 opacity-30" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h14a1 1 0 011 1v2l-8 5-8-5V3z" />
                    <path d="M18 8l-8 5-8-5v7a1 1 0 001 1h14a1 1 0 001-1V8z" />
                </svg>
            </div>
        ...
        {{-- Kartu Surat Keluar --}}
        <div class="dark:bg-red-700 text-white rounded shadow p-4">
            <div class="flex justify-between items-center">
                <div>
